...
const Hearder = ({children}) => {
  const menubar=[
    ...
    <li> <a className="hover:text-[#ff014f]" href='#home'>Home</a> </li>,
    <li> <a className="hover:text-[#ff014f]" href='#features'>Features</a></li>,
    <li> <a className="hover:text-[#ff014f]" href='#portfolio'>Portfolio</a></li>,
    <li> <a className="hover:text-[#ff014f]" href='#skill'>Skill</a></li>,
    <li> <a className="hover:text-[#ff014f]" href='#blog'>Blog</a> </li>,
    <li><a className="hover:text-[#ff014f]" href='#contact'>Contact</a> </li>,
